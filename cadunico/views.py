...
def CadastrosGerais(request):
    ...
    mun = MunicipioBeneficiado.objects.filter(pessoas_cadunico_d__year='2016', pessoas_cadunico_d__month='12', pessoas_cadunico_d__day='01').order_by('municipio__municipio')
...
def ExtratoRendaFamilias(request):
    ...
    obj = MunicipioBeneficiado.objects.filter(pessoas_cadunico_d__year='2016', pessoas_cadunico_d__month='12', pessoas_cadunico_d__day='01').order_by('municipio__municipio')
    est = EstadoBeneficiado.objects.all().order_by('estado__uf')
    pais = PaisBeneficiado.objects.all().order_by('pais__pais')
